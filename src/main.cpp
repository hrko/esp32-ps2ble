...
void notifyCB(NimBLERemoteCharacteristic* pRemoteCharacteristic, uint8_t* pData, size_t length, bool isNotify) {
  ...
  switch (length) {
    ...
    case 5:
      ...
      Serial.printf("buttons: %02x, x: %d, y: %d, wheel: %d hwheel: %d", pData[0], (int8_t)pData[1], (int8_t)pData[2], (int8_t)pData[3],
                    (int8_t)pData[4]);
      break;
    case 6:
      ...
      } trackball_mouse_t;
      {
        ...
        Serial.printf("buttons: %02x, x: %d, y: %d, wheel: %d", my_mouse->buttons, my_mouse->x, my_mouse->y, my_mouse->wheel);
      }
      break;
    case 9:
      ...
      if (appearance == APPEARANCE_HID_MOUSE) {
        ...
        } ms_mouse_t;
        {
          ...
          Serial.printf("buttons: %02x, x: %d, y: %d, wheel: %d, pan: %d", my_mouse->buttons, my_mouse->x, my_mouse->y, my_mouse->wheel,
                        my_mouse->pan);
        }
        ...
        } joystick_t;
        {
          ...
          Serial.printf("buttons: %02x, x: %d, y: %d", my_joystick->buttons, my_joystick->x, my_joystick->y);
        }
      }
      break;
  }
